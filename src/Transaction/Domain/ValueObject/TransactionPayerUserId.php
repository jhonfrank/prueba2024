...
/**
 * Clase para el ValueObject TransactionPayerUserId.
 */
final class TransactionPayerUserId extends IntValueObject
{
	...
	{
		if ($value < 0) {
			throw new BadRequestException("The payer user id is negative.");
		}
	}
}